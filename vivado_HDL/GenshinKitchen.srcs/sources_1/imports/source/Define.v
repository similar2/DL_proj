...
parameter SCRIPT_IDLE = 0,SCRIPT_STARTMOVING = 1,SCRIPT_MOVING = 2,SCRIPT_DOING = 3,SCRIPT_DONE = 4;


parameter BCD_NUM = 4;
parameter BCD_EMPTY = 4'b0000;
parameter BCD_FIRST = 4'b0001;
parameter BCD_SECOND = 4'b0010;
parameter BCD_THRID = 4'b0100;
parameter BCD_FORTH = 4'b1000;
parameter BCD_LETTER_G = 8'b11110110;
parameter BCD_LETTER_H = 8'b00101110;
parameter BCD_LETTER_E = 8'b10011110;
parameter BCD_LETTER_I = 8'b01100000;
parameter BCD_LETTER_N = 8'b11101100;
parameter BCD_LETTER_S = 8'b10110110;
